...
namespace App\Module\Products\Category\Entity\Event;

use App\Module\Products\Category\Entity\Category;
use App\Module\Products\Category\Entity\Cover\Cover;
use App\Module\Products\Category\Entity\Info\Info;
use App\Module\Products\Category\Entity\Landing\Landing;
...
use App\Module\Products\Category\Entity\Seo\Seo;
use App\Module\Products\Category\Entity\Trans\Trans;
...
class Event extends EntityEvent
{
    ...
    /** Cover */
    #[ORM\OneToOne(mappedBy: 'event', targetEntity: Cover::class, cascade: ['persist', 'remove'])]
...
//    }
    ...
    {
        return $this->cover ?: $this->cover = new Cover($this);
    }

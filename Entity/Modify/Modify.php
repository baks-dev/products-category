...
namespace App\Module\Products\Category\Entity\Modify;
...
class Modify extends EntityEvent
{
    ...
    /** Связь на событие */
    #[ORM\Id]
    #[ORM\OneToOne(inversedBy: 'modify', targetEntity: Event::class)]
    ...
    public function __construct(Event $event, ModifyAction $modifyAction)
    {
        $this->event = $event;

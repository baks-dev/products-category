# BaksDev Products Category

![Version](https://img.shields.io/badge/version-0.0-blue) ![php 8.1+](https://img.shields.io/badge/php-min%208.1-red.svg)
...
``` json
{
    ...
    "extra": {
        ...
        "installer-paths": {
            "src/Module/Products/Category": ["baks-dev/products-category"]
        }
    }
}
```
